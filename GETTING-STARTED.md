...
- **Claude Code** (CLI) - Terminal workflows, automation, hooks
- **Claude Cowork** (Desktop App) - Interactive conversations, natural language
...
**For Claude Cowork:**
1. Go to [claude.ai](https://claude.ai)
2. Download Claude Cowork desktop app for your computer
3. Follow the installation instructions

**Installation is the same for both** - they both read from the `.claude/` directory structure created by install.sh.

See [Cowork vs Code Guide](docs/COWORK-VS-CODE.md) to understand how skills and agents work in each environment.
...
## Using Slash Commands (Claude Code Only)

In Claude Code CLI, you can also use quick commands:
...
## Using in Claude Cowork (Desktop App)

In Cowork, reference skills and agents naturally:

**Skills:**
- "Use the code-review skill to check this function"
- "Help me with daily-plan skill"
- "Apply the systems-decompose skill to this feature"

**Agents:**
- "Read the fundraising-expert agent and use that approach"
- "Apply the code-architect methodology to this design"

Claude will automatically read the relevant files from `.claude/skills/` and `.claude/agents/`.

See [Cowork vs Code Guide](docs/COWORK-VS-CODE.md) for detailed differences.
